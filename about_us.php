...
<body style="background-color:#000000;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/Debasish.jpeg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Debasish Kumar Baidya</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Netaji Subhash Engineering College, West Bengal</b></p>

            <!-- Add icon library -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">

<!-- Add font awesome icons -->
<a href="https://github.com/debasishkumarbaidya" class="fa fa-github"></a>
<a href="https://www.linkedin.com/in/debasishkumarbaidya/" class="fa fa-linkedin"></a>
<a href="https://www.youtube.com/channel/UCAsL8cnmH2riTORbWLCDbpA" class="fa fa-youtube"></a>
<a href="https://www.facebook.com/debasishkumar.baidya.5" class="fa fa-facebook"></a>
<a href="https://www.instagram.com/debasish.kumar.baidya/" class="fa fa-instagram"></a>
<a href="https://twitter.com/DKBCSE" class="fa fa-twitter"></a>
